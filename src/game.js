...
game = {
  ...
  timers:{
    ...
    levelCompleted:mge.game.createTimer(5000 ,'X'),
    red:mge.game.createTimer(1500 ,'X'),
    oran:mge.game.createTimer(1500 ,'X'),
    yell:mge.game.createTimer(1500 ,'X'),
    gree:mge.game.createTimer(1500 ,'X'),
    cyan:mge.game.createTimer(1500 ,'X'),
    blue:mge.game.createTimer(1500 ,'X'),
    mage:mge.game.createTimer(1500 ,'X'),
  },
  instruments:{},
  system:{},
  tools:{
